...
<head>
    ...
    <link rel="stylesheet" href="<?php echo CSS.'style-1.css' ?>"/>
...
<div class="container">
    <div class="col-md-10 col-md-offset-1">
        <div class="popup-content blue-light-bg">
            <div class="col-md-5 text-right">
                <div class="leftSide">
                    <img src="<?php echo IMG.'book.png' ?>" alt=""/>
                </div>
            </div>
            <div class="col-md-7 noPaddingRight">
                <div class="rightSide">
                    ...
                    <div class="col-md-12">
                        <div class="heading">
                            <h1 class="text-shadow">Does Your Child <br> Really Need Braces?</h1>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-12">
                            <div class="question">
                                <div class="col-md-6">
                                    <a class="text-shadow" href="">• How to know?</a>
                                    <a class="text-shadow" href="">• How to choose?</a>
                                </div>
                                <div class="col-md-6">
                                    <a class="text-shadow" href="">• When to start braces?</a>
                                </div>
                            </div>
                        </div>
                    </div>
